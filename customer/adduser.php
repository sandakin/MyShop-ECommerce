...
$("#availability_status1").html('<font color="#cc0000">Username too short</font>');
//if in case the username is less than or equal 3 characters only 
...
<div class="form-group">
    ...
    <input type="text" name="c_mname" id="c_mname" class="form-control"  placeholder="Enter Middle Name" required/>
</div>
...
<div class="form-group">
    ...
    <input type="email" name="c_email" id="c_email" class="form-control"  placeholder="Enter E mail" required/>
