...
<tr>
 ...
 <td class="col-md-10">
 <div class="alert alert-success" role="alert">Order placed successfully. <span class="glyphicon glyphicon-ok" aria-hidden="true"></span></div>
 <div class="alert alert-info" role="alert">Details on you order can be viewed on your<a href="../logorreg/accountorder.php"> <strong>Account Page</strong></a> </div>
